...
class PaginationIntegrationTest {
    ...
    @Test
    fun testBasicPaginationStreaming() =
        runBlocking {
    ...
    @Test
    fun testSmallChunkSizePagination() =
        runBlocking {
    ...
    @Test
    fun testEarlyTerminationScenario() =
        runBlocking {
            // Setup: Large dataset
            val totalItems = 1000
            val pageSize = 100
    ...
    @Test
    fun testPaginationWithFiltering() =
        runBlocking {
    ...
    @Test
    fun testPaginationWithTransformation() =
        runBlocking {
    ...
    @Test
    fun testPaginationErrorRecovery() =
        runBlocking {
    ...
    @Test
    fun testPaginationWithCacheConfiguration() =
        runBlocking {
    ...
    private fun setupPaginatedDataset(
        totalItems: Int,
        pageSize: Int,
    ) {
        var offset = 0
