...
class DataTypeConversionTest {
                ...
                data =
                    (1..10000).map { index ->
                        buildJsonObject {
                            ...
                            put(
                                "content",
                                "Content for article number $index with some additional text to make it realistic",
                            )
    ...
    fun `test immutability and defensive copying`() {
        ...
        val modifiedEntry =
            originalEntry.toMutableMap().apply {
